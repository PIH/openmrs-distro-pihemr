...
@Component
public class DxUtilVelocityContextContentProvider implements VelocityContextContentProvider {
    ...
    public void populateContext(FormEntrySession formEntrySession, VelocityContext velocityContext) {
        ...
        List<Concept> conditionListConcepts = (List<Concept>) velocityContext.get("conditionListConcepts");
        System.out.println("conditionListConcepts: " + conditionListConcepts);
        log.info("conditionListConcepts: " + conditionListConcepts);
