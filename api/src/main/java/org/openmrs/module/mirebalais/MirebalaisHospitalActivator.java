...
public class MirebalaisHospitalActivator implements ModuleActivator {
	...
	public MirebalaisHospitalActivator() {
		...
		currentMetadataVersions.put("32d52080-13fa-413e-a23e-6ff9a23c7a69", "HUM_Locations-2.zip");
		currentMetadataVersions.put("f12f5fb8-80a8-40d0-a20e-24af2642ce4c", "Roles_and_privileges-2.zip");
		currentMetadataVersions.put("fa25ad0c-66cc-4715-8464-58570f7b5132", "PIH_Haiti_Patient_Registration-5.zip");
